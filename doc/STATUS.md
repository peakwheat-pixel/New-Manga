...
| Last verified product test status | `d05b3db`: 951 collected = 945 passed / 6 skipped / EXIT=0; six skips are the existing `openssl unavailable` network cases. Evidence: `verification/TASK-065/baseline-full-suite.log`. |
