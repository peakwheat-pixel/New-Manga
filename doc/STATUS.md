...
| Current Active Task | [T3.2.1](tasks/T3.2.1.md) full Release Gate closure. REPAIR-8 is `approved`, not `done`; a clean-Sandbox startup failure now requires a packaging dependency repair before AC3/AC4 can pass. |
| Current owner/reviewer | Antigravity owns packaging implementation within the released T3.2.1 scope; DeepSeek Harness remains the independent reviewer. Codex owns Gate disposition and integration. REPAIR-8 approval covers documentation only. |
