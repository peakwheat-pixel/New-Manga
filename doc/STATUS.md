...
| 项目 | 状态 |
|---|---|
| 阶段 | TASK-001～TASK-010、TASK-012、TASK-014、TASK-028 设计、TASK-029 与 TASK-031 已完成并集成；TASK-030 装配切片已授权并登记 `READY`，尚未实施；其他业务功能继续冻结 |
| 当前授权 | TASK-012 已完成独立 Review 与串行集成；2026-09-16 用户明确授权 TASK-031，已按白名单完成 Review/集成；本次用户授权释放 TASK-030 入口装配最小切片，允许 ZCode 认领实施；TASK-011、TASK-013、TASK-015～TASK-027 及其他业务功能仍冻结，不得释放 TASK-013/TASK-015 或其他冻结 Task |
| 接管审核 | approved |
...
TASK-030 已获授权进入 READY：[TASK-030](tasks/TASK-030.md) 固定 `base_commit=087da45590c84227e9695eb829669e9cee805ef2`、Owner=`ZCode`、Reviewer=`DeepSeek Harness`、branch=`agent/zcode/TASK-030-main-bootstrap-assembly`、worktree=`G:/CODEX/New Manga.worktrees/TASK-030-zcode`；生产路径为 `src/ui/qml/Main.qml` 与 `src/bootstrap/app.py`，其依赖 TASK-031 `integration_commit=e9d5185` 已核实就绪；尚未实施，不释放 TASK-013/TASK-015。

TASK-031 已完成 Review 与集成：[TASK-031](tasks/TASK-031.md) 固定 `base_commit=29b146f`、`reviewed_head=c67a105`、`implementation_merge=0b44b83`、`integration_commit=e9d5185`、Owner=`Codex`、Reviewer=`DeepSeek Harness`；R-001～R-003 已关闭。TASK-030 消费其生产 Qt 解码/Managed Copy 适配器，入口 smoke、真实 SQLite 导入探针与 DPI 证据继续由 TASK-030 独立范围处理。
