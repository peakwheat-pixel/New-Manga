...
| Current product checkpoint | T1.1.1, T1.1.2, T1.2.1, T2.1.1, T2.2.1, and T3.1.1 are VERIFIED_COMPLETE. T3.2.1 remains unintegrated and not release-ready; REPAIR-8/10/12 slice reviews are approved (scope-limited), REPAIR-9 remains `changes_requested`, and the historical REPAIR-11 `changes_requested` review has a separately approved evidence-only follow-up. Fixed Build 3's manual AC3 attempt is blocked at image import; REPAIR-13 is released to Qoder for the bounded QML repair. Full Gate closure remains Codex-owned. |
| Current Active Task | [T3.2.1](tasks/T3.2.1.md) full Release Gate closeout (Codex), with child [REPAIR-13](tasks/T3.2.1-REPAIR-13.md) `ready` for image-import/readability repair. [REPAIR-12](tasks/T3.2.1-REPAIR-12.md) received slice Review `approved`; its delivery remains unmerged and does not close the parent Gate. |
| Parallel research Task | [M2-D1 Headless & Qt Coupling Audit](tasks/M2-D1.md) is `ready` for DeepSeek Harness, with Codex non-author Reviewer. Fixed code base=`307a940265fc325076fe77698750392531f8fce1`; branch=`agent/deepseek/M2-D1-headless-qt-coupling-audit`; worktree=`G:/CODEX/New Manga.worktrees/M2-D1-deepseek-audit`. Source is read-only; M2 implementation remains `NOT_RELEASED`. Owner has not started; Codex CLI dispatch attempt ended with `AUTH` (exit 1), so DSH Web handoff remains available. |
| Current owner/reviewer | Full Gate Owner=Codex; final full-scope Reviewer=DeepSeek Harness (independent non-author). REPAIR-13 Owner=Qoder; Reviewer=DeepSeek Harness (independent non-author). |
| Current branch/worktree | Main: `G:/CODEX/New Manga`, `master`; evidence update started at HEAD `5f6cfc945dc96f2dc621013d43d695d431e9789a` (unrelated dirty files preserved). Isolated product candidate remains `codex/T3.2.1-release-gate-closeout` at `188d72a9d144b8cab16f77757abc46318ac8e5e6`, not merged. REPAIR-12 branch tip=`8738c41d7215920935e6fa067d3740e69280cdc6`; independent Reviewer commit=`a6564862649b00fd91fa4e4ea8a2f64205eb71b7`. REPAIR-13 worktree=`G:/CODEX/New Manga.worktrees/T3.2.1-qoder-repair-13`, branch=`agent/qoder/T3.2.1-repair-13`, clean at fixed base `8738c41d7215920935e6fa067d3740e69280cdc6`. The legacy REPAIR-11 branch stays preserved at `941dbc89e139a2e24e6b1d17c900e363995decfc`. |
...
| REPAIR-13 registration | Qoder / DeepSeek Harness; `ready` at base=`8738c41d7215920935e6fa067d3740e69280cdc6`; branch=`agent/qoder/T3.2.1-repair-13`; worktree=`G:/CODEX/New Manga.worktrees/T3.2.1-qoder-repair-13`. Scope: QML chapter-image import wiring/feedback and button readability; Reader Export retest only after valid pages/chapter selection. No product changes are integrated. |
...
| Field | Current value |
|---|---|
| `TaskStatus` | T1.2.1, T2.1.1, T2.2.1 and T3.1.1 `VERIFIED_COMPLETE`; T3.2.1 `in_progress / release_gate_open`; REPAIR-8/10/12 approved (scope-limited); REPAIR-9 remains `changes_requested`; REPAIR-13 `ready` (QML import/readability) |
...
| `Safe To Resume` | Qoder may start REPAIR-13 from fixed base `8738c41`; Codex continues parent Gate closeout after that child delivery and independent Review. The release candidate remains isolated at `188d72a`. |
...
| T3.2.1-REPAIR-13 | ready | QML import wiring/readability | Qoder owner, DeepSeek Harness independent reviewer; fixed base `8738c41`; AC3 remains blocked pending repair and fresh Sandbox run |
