...
TASK-001～TASK-010、TASK-012、TASK-014、TASK-028 设计与 TASK-029 统一 SQLite 持久化实现已完成并集成；TASK-031 生产 ImageDecoder/Managed Copy 适配器已交付待审；TASK-030 入口装配范围已建立但等待 TASK-031；TASK-011、TASK-013、TASK-015～TASK-027 保持 `proposed`。**建议 Owner 不是实际派单。** 单个 Task 文件是状态真值，本表只提供标题和依赖导航。详细阶段与 Gate 见 [STATUS](../STATUS.md) 与 [Roadmap](../12_ROADMAP.md)。
...
| [TASK-030](TASK-030.md) | Main.qml/bootstrap 最小生产装配 | ZCode | blocked；base `78987c8`；TASK-005, TASK-007, TASK-012, TASK-029 |
| [TASK-031](TASK-031.md) | 生产 ImageDecoder 与 Managed Copy 适配器 | Codex | in_review；base `29b146f`；TASK-006, TASK-007, TASK-029 |
