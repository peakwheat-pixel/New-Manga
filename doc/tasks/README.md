...
| [TASK-034](TASK-034.md) | 测试与分层硬化（route policy 收敛 / 架构守卫 / flaky 诊断） | DeepSeek Harness | **in_progress**；**AC ②③④⑤ 已 Review approved 并集成**（Review=[TASK-034-f83a33e](../reviews/TASK-034-f83a33e.md)、integration=`b6051e5`、复验 [integration-b6051e5](../../verification/TASK-034/integration-b6051e5.md)；四轴 executed、不跨轴排名、并行偏差已声明；集成后 mandated 三套件 **193 passed/0 skipped**、AC ④ 两种顺序 **136/136**、全仓 **682 passed/6 skipped**）；**AC ① 第 1 步已交付、裁决已出**（[TASK-034-ac1-route-policy-ruling](../reviews/TASK-034-ac1-route-policy-ruling.md)：R-6 **Option B**、`src/` 三文件范围已批准），**第 2 步未开始**；**未关闭项**：AC ① 第 2 步、**R-01（P2，`tests/reading_export` 裸 `conftest` 导入，硬绑定为第 2 步强制项）**、R-05/R-06/R-07 登记；**Task 不得 `done`**；TASK-019（done） |
