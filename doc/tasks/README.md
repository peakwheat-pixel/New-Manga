...
| [TASK-019](TASK-019.md) | 集成已验证的检测/OCR/翻译/修复 Provider | DeepSeek Harness | done；Review=[TASK-019-726baf5](../reviews/TASK-019-726baf5.md) approved（F-1～F-7）、integration=`3755af9`；集成后 `tests/providers` 110 passed/0 skipped、全仓 640 passed/6 skipped；**AC-RFULL-001 完整链 `BLOCKED`**（缺 `color`/`term_extract`/`render` handler）；**F-1 跨 Task P0 待裁决**（默认 `sfx_policy='skip'` + planner 不看 `region_type`）；依赖 TASK-011, TASK-014, TASK-016, TASK-017, TASK-018, TASK-024（均已 done） |
