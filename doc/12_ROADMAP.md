...
这里的顺序是建议，不以用户批准接管推定其批准全部开发。TASK-009、TASK-010、TASK-011、TASK-012、TASK-013、TASK-014、TASK-030 与 TASK-031 已完成集成；R-1 已完成；TASK-015 与 TASK-016 已获批准并登记为 ready；TASK-017～TASK-027 仍冻结；默认同一 ZCode 实例不得并行实现两个 Task，本次 TASK-012 例外使用独立 worktree/branch，其他任务仍遵循默认规则。用户若明确批准一组任务，Codex据此持续完成该组，无需重复请求同一授权。
...
- 所有 Task 文件包含硬依赖、Acceptance Criteria、允许路径、测试要求与阻塞；TASK-001～TASK-014、TASK-028、TASK-029、TASK-030、TASK-031 已 done，TASK-015、TASK-016 为 ready，TASK-017～TASK-027 为 proposed/frozen。
