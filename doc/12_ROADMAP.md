...
PDF/MOBI、字体上传、Sakura监控、Plugin/Hooks与Plugin Agent仍有待决契约；网页导入已由用户于 2026-09-17 按 U-1 取消，相关 AC-EXT-IMPORT-001/002 退役。U-2 已选 PDFium via `pypdfium2`；U-3～U-6 仍待裁决。TASK-023/025/019/022 继续冻结或 blocked，决定本身不释放任务。
