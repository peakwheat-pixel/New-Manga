...
状态：**草案，待用户批准**。本文件 §1 共列 15 条 AC-EXT-* 产品验收草案；它们须经
U-1~U-6 用户裁决批准后才可转为正式编号 AC，批准前不得作为已接受或已验证的验收依据。
本文件是 [STATUS](../STATUS.md) 授权窗口内 TASK-024 的唯一设计交付；它只定义边界与条件，
不实现任何扩展，也不默认扩建或删除任何 D01 已列能力（G17：来源存在、契约与 AC 不完整）。
产品取舍经用户批准后才对 TASK-023/025/019/022 释放；未批准前相关 Task 不得据此开工。
