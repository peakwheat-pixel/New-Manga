...
> **Current pointer（2026-09-24）**：T1.1.1、T1.1.2、T1.2.1、T2.1.1、T2.2.1、T3.1.1 已集成并验证；T3.1.1 产品 head=`0c70e44`，独立 Review=`4e1eb3a`，集成证据为 [integration-899bd3c](../verification/T3.1.1/integration-899bd3c.md)。T3.2.1 全量 Release Gate 仍 OPEN；REPAIR-12 Review `a656486` 对证据修订切片 `approved`，不代表全量 Gate 通过。Codex 当前执行全量 Gate 收口；AC3 交互主流程=`NOT_RUN` 且为发布阻断项，AC5=`NOT_RUN`、AC6/AC7=`PARTIAL / NOT_RUN`、AC8/AC9=`NOT_RUN`、R-014～R-016=`OPEN`。O-12-2 的处置及固定检查见 [Codex closeout](../verification/T3.2.1/release-gate-closeout-b800d11.md)。当前状态与执行恢复点见 [STATUS](STATUS.md)；任务顺序见 [REBASELINE_PLAN](REBASELINE_PLAN.md)。下方 2026-09-19 及更早的长段落是历史导航，不决定当前排期。
