...
> **Current pointer（2026-09-22）**：T1.1.1 已于 `f56f441` 集成并验证；T1.2.1 已交付但 Review 阻断，尚未集成。当前 HEAD、测试口径、阻断项与下一 Release Gate 见 [STATUS](STATUS.md)；任务顺序见 [REBASELINE_PLAN](REBASELINE_PLAN.md)。下方 2026-09-19 及更早的长段落是历史导航，不决定当前排期。
