...
> **Current pointer（2026-09-22）**：T1.1.1、T1.1.2、T1.2.1、T2.1.1 已集成并验证；T2.2.1 已通过 Codex Release Gate，正式 Task 为 [T2.2.1](tasks/T2.2.1.md)，base=`16810c5`，实现尚未开始。Release evidence：[T2.2.1 gate](../verification/T2.2.1/release-gate-ef1a9b8.md)。当前 HEAD、测试口径、阻断项与执行恢复点见 [STATUS](STATUS.md)；任务顺序见 [REBASELINE_PLAN](REBASELINE_PLAN.md)。下方 2026-09-19 及更早的长段落是历史导航，不决定当前排期。
